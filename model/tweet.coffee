class App.Models.Tweet extends Backbone.Model
  ...
  analyze: ->
    ...
    @set
      analysed_words: words.concat @extractWords @get 'text_without_entities'

  extractEntities: ->
    entities    = @get 'entities'
    empty_text  = self.emptyText
    text        = @get 'text'
    ...
    for [startIndex, endIndex] in indices
      ...
      text = text[0...startIndex] + empty_text[startIndex...endIndex] + text[endIndex..]

    @set text_without_entities: text
    entityWords
